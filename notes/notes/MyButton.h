...
//  notes
//
//  Created by Samez on 11.05.13.
//  Copyright (c) 2013 gg. All rights reserved.
//

#ifndef notes_MyButton_h
#define notes_MyButton_h
...
+ (UIView *)flipButtonWithFirstImage:(UIImage *)firstImage
    ...
    [button1 setBackgroundImage:firstImage forState:UIControlStateDisabled];
    ...
    [button2 setBackgroundImage:secondImage forState:UIControlStateHighlighted];
    [button2 setBackgroundImage:secondImage forState:UIControlStateSelected];
    [button2 setBackgroundImage:secondImage forState:UIControlStateReserved];
    [button2 setBackgroundImage:secondImage forState:UIControlStateApplication];
    [button2 setBackgroundImage:secondImage forState:UIControlStateDisabled];
    ...
    UIView *container = [[UIView alloc] initWithFrame:button1.bounds];
